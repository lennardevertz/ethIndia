...
<div className="mt-3">
    ...
    <div className="mr-1 flex items-center justify-end">
      ...
      <label for="SubjectCheckbox" className="ml-1 block text-sm text-gray-500">Subject</label>
      ...
      <label for="MediaCheckbox" className="ml-1 block text-sm text-gray-500">Media</label>
...
{/* CONNECT WALLET & SEND BUTTON */}
    <div className="flex justify-center mt-3">
        <button type="button" onclick="" className="w-full justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#11dd74] text-base font-medium text-white hover:bg-[#11cc74]">
